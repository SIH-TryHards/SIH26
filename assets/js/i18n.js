...
const hi = {
  ...
  'distress.title': 'जोखिम जाँच',
  'distress.subtitle': 'मौसम, भाव और ऋण की स्थिति बदलकर जोखिम समझें।',
  'distress.riskScore': 'जोखिम स्कोर',
  'distress.critical': 'बहुत अधिक जोखिम — अभी ध्यान दें',
  'distress.watch': 'ध्यान रखें',
  'distress.rainLabel': '3 दिन की बारिश का अनुमान',
  'distress.priceLabel': 'औसत के मुकाबले मंडी भाव में गिरावट',
  'distress.loanLabel': 'अगली ईएमआई तक दिन',
  'loan.status.emi': 'मासिक ईएमआई',
  'loan.status.totalInterest': 'कुल ब्याज',
  'loan.schedule.title': 'भुगतान की सूची',
  'loan.schedule.baseEmi': 'मूल ईएमआई',
  'distress.planningNote': 'मौसम, मंडी भाव और ऋण की समय-सारणी बदलकर अपनी योजना का जोखिम समझें।',
  'distress.scaleLow': 'सामान्य',
  'loan.schedule.dueDate': 'देय तारीख (महीने की पहली तारीख)',
  'loan.schedule.balance': 'बाकी मूलधन',
  'loan.schedule.totalDueMonth': 'इस महीने की कुल देय राशि',
  'loan.schedule.rolloverArrears': 'पिछली बकाया राशि',
  'help.schemesIntro': 'किसान सहायता और सरकारी योजनाओं के बारे में जानें।',
  'profile.emailLabel': 'ईमेल (वैकल्पिक)',
  'profile.contactLabel': 'पसंदीदा संपर्क माध्यम',
  'profile.themeLabel': 'दिखावट',
  'profile.clearData': 'सारा डेटा मिटाएँ',
...
const mr = {
  ...
  // Autogenerated translations
  'distress.title': 'जोखीम तपासणी',
  'distress.subtitle': 'हवामान, बाजारभाव आणि कर्जाची स्थिती बदलून जोखीम समजून घ्या.',
  'distress.riskScore': 'जोखीम गुण',
  'distress.critical': 'खूप जास्त जोखीम — आत्ताच लक्ष द्या',
  'distress.watch': 'लक्ष ठेवा',
  'distress.rainLabel': '3 दिवसांचा पावसाचा अंदाज',
  'distress.priceLabel': 'सरासरीच्या तुलनेत बाजारभावातील घट',
  'distress.loanLabel': 'पुढील EMI पर्यंत दिवस',
  'loan.status.emi': 'मासिक EMI',
  'loan.status.totalInterest': 'एकूण व्याज',
  'loan.schedule.title': 'परतफेड वेळापत्रक',
  'loan.schedule.baseEmi': 'मूळ EMI',
  'distress.planningNote': 'हवामान, बाजारभाव आणि कर्जाची वेळ बदलून आपल्या योजनेतील जोखीम समजून घ्या.',
  'distress.scaleLow': 'सामान्य',
  'loan.schedule.dueDate': 'देय तारीख (महिन्याची पहिली तारीख)',
  'loan.schedule.balance': 'उर्वरित मुद्दल',
  'loan.schedule.totalDueMonth': 'या महिन्यातील एकूण देय रक्कम',
  'loan.schedule.rolloverArrears': 'मागील थकबाकी',
  'help.schemesIntro': 'शेतकरी मदत आणि सरकारी योजनांबद्दल जाणून घ्या.',
  'profile.emailLabel': 'ईमेल (ऐच्छिक)',
  'profile.contactLabel': 'प्राधान्याचा संपर्क',
  'profile.themeLabel': 'दिखावट',
  'profile.clearData': 'सर्व डेटा हटवा',
  'help.visitReasonHint': 'Briefly describe why you need a visit.',
  'help.visitReasonTooShort': 'Please provide at least 10 characters.',
  'help.kccSupport': '24/7 toll-free support',
  'help.disasterSupport': '24/7 emergency line',
...
const bn = {
  ...
  // Autogenerated translations
  'distress.title': 'ঝুঁকি যাচাই',
  'distress.subtitle': 'আবহাওয়া, বাজারদর ও ঋণের সময় বদলে ঝুঁকি বুঝুন।',
  'distress.riskScore': 'ঝুঁকির স্কোর',
  'distress.critical': 'অতি বেশি ঝুঁকি — এখনই নজর দিন',
  'distress.watch': 'নজর রাখুন',
  'distress.rainLabel': '৩ দিনের বৃষ্টির পূর্বাভাস',
  'distress.priceLabel': 'গড়ের তুলনায় বাজারদরের পতন',
  'distress.loanLabel': 'পরের EMI পর্যন্ত দিন',
  'loan.status.emi': 'মাসিক EMI',
  'loan.status.totalInterest': 'মোট সুদ',
  'loan.schedule.title': 'পরিশোধের সময়সূচি',
  'loan.schedule.baseEmi': 'মূল EMI',
  'distress.planningNote': 'আবহাওয়া, বাজারদর ও ঋণের সময় বদলে আপনার পরিকল্পনার ঝুঁকি বুঝুন।',
  'distress.scaleLow': 'স্বাভাবিক',
  'loan.schedule.dueDate': 'পরিশোধের তারিখ (মাসের ১ তারিখ)',
  'loan.schedule.balance': 'বাকি মূলধন',
  'loan.schedule.totalDueMonth': 'এই মাসে মোট বকেয়া',
  'loan.schedule.rolloverArrears': 'আগের বকেয়া',
  'help.schemesIntro': 'কৃষক সহায়তা ও সরকারি প্রকল্প সম্পর্কে জানুন।',
  'profile.emailLabel': 'ইমেল (ঐচ্ছিক)',
  'profile.contactLabel': 'পছন্দের যোগাযোগ',
  'profile.themeLabel': 'দেখানোর ধরন',
  'profile.clearData': 'সব তথ্য মুছে দিন',
  'help.visitReasonHint': 'Briefly describe why you need a visit.',
  'help.visitReasonTooShort': 'Please provide at least 10 characters.',
  'help.kccSupport': '24/7 toll-free support',
  'help.disasterSupport': '24/7 emergency line',
...
const ta = {
  ...
  // Autogenerated translations
  'distress.title': 'ஆபத்து ஆய்வு',
  'distress.subtitle': 'வானிலை, சந்தை விலை மற்றும் கடன் நேரத்தை மாற்றி ஆபத்தைப் புரிந்துகொள்ளுங்கள்.',
  'distress.riskScore': 'ஆபத்து மதிப்பெண்',
  'distress.critical': 'மிக அதிக ஆபத்து — இப்போது கவனம் தேவை',
  'distress.watch': 'கவனிக்கவும்',
  'distress.rainLabel': '3 நாள் மழை முன்னறிவிப்பு',
  'distress.priceLabel': 'சராசரியுடன் ஒப்பிடும் சந்தை விலை வீழ்ச்சி',
  'distress.loanLabel': 'அடுத்த EMI வரை நாட்கள்',
  'loan.status.emi': 'மாத EMI',
  'loan.status.totalInterest': 'மொத்த வட்டி',
  'loan.schedule.title': 'திருப்பிச் செலுத்தும் அட்டவணை',
  'loan.schedule.baseEmi': 'அடிப்படை EMI',
  'distress.planningNote': 'வானிலை, சந்தை விலை மற்றும் கடன் நேரத்தை மாற்றி உங்கள் திட்டத்தின் ஆபத்தைப் புரிந்துகொள்ளுங்கள்.',
  'distress.scaleLow': 'இயல்பு',
  'loan.schedule.dueDate': 'செலுத்த வேண்டிய தேதி (மாதத்தின் 1ஆம் தேதி)',
  'loan.schedule.balance': 'மீதமுள்ள அசல் தொகை',
  'loan.schedule.totalDueMonth': 'இந்த மாதத்தின் மொத்தத் தொகை',
  'loan.schedule.rolloverArrears': 'முந்தைய நிலுவை',
  'help.schemesIntro': 'விவசாயி உதவி மற்றும் அரசு திட்டங்களை அறிந்துகொள்ளுங்கள்.',
  'profile.emailLabel': 'மின்னஞ்சல் (விருப்பம்)',
  'profile.contactLabel': 'விருப்பமான தொடர்பு',
  'profile.themeLabel': 'தோற்றம்',
  'profile.clearData': 'எல்லா தரவையும் அழிக்கவும்',
  'help.visitReasonHint': 'Briefly describe why you need a visit.',
  'help.visitReasonTooShort': 'Please provide at least 10 characters.',
  'help.kccSupport': '24/7 toll-free support',
  'help.disasterSupport': '24/7 emergency line',
...
const te = {
  ...
  // Autogenerated translations
  'distress.title': 'ప్రమాద పరిశీలన',
  'distress.subtitle': 'వాతావరణం, మార్కెట్ ధర మరియు రుణ సమయాన్ని మార్చి ప్రమాదాన్ని అర్థం చేసుకోండి.',
  'distress.riskScore': 'ప్రమాద స్కోర్',
  'distress.critical': 'చాలా ఎక్కువ ప్రమాదం — ఇప్పుడే శ్రద్ధ వహించండి',
  'distress.watch': 'గమనించండి',
  'distress.rainLabel': '3 రోజుల వర్ష సూచన',
  'distress.priceLabel': 'సగటుతో పోలిస్తే మార్కెట్ ధర తగ్గుదల',
  'distress.loanLabel': 'తదుపరి EMI వరకు రోజులు',
  'loan.status.emi': 'నెలవారీ EMI',
  'loan.status.totalInterest': 'మొత్తం వడ్డీ',
  'loan.schedule.title': 'తిరిగి చెల్లింపు షెడ్యూల్',
  'loan.schedule.baseEmi': 'ప్రాథమిక EMI',
  'distress.planningNote': 'వాతావరణం, మార్కెట్ ధర మరియు రుణ సమయాన్ని మార్చి మీ ప్రణాళికలోని ప్రమాదాన్ని అర్థం చేసుకోండి.',
  'distress.scaleLow': 'సాధారణం',
  'distress.priceLabel': 'MSPతో పోలిక',
  'loan.schedule.dueDate': 'చెల్లింపు తేదీ (నెల 1వ తేదీ)',
  'loan.schedule.balance': 'మిగిలిన అసలు',
  'loan.schedule.totalDueMonth': 'ఈ నెల మొత్తం చెల్లించాల్సింది',
  'loan.schedule.rolloverArrears': 'మునుపటి బకాయి',
  'help.schemesIntro': 'రైతు సహాయం మరియు ప్రభుత్వ పథకాల గురించి తెలుసుకోండి.',
  'profile.emailLabel': 'ఈమెయిల్ (ఐచ్ఛికం)',
  'profile.contactLabel': 'ఇష్టమైన సంప్రదింపు',
  'profile.themeLabel': 'రూపం',
  'profile.clearData': 'మొత్తం డేటాను తొలగించండి',
  'help.visitReasonHint': 'Briefly describe why you need a visit.',
  'help.visitReasonTooShort': 'Please provide at least 10 characters.',
  'help.kccSupport': '24/7 toll-free support',
  'help.disasterSupport': '24/7 emergency line',
